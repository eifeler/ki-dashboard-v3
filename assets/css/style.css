/* ============================================================
   KI-DASHBOARD – Main Stylesheet
   Design: Dark Tech / Modern / Clean
   ============================================================ */
...
.stat-widget:hover { border-color: var(--border-bright); box-shadow: 0 4px 20px rgba(0,0,0,0.2); }
.stat-icon {
...
.stat-value { font-size: 1.6rem; font-weight: 700; line-height: 1; letter-spacing: -0.5px; }
.stat-change { font-size: 0.72rem; color: var(--accent-green); margin-top: 4px; }
...
.tool-card-header { display: flex; align-items: flex-start; justify-content: space-between; margin-bottom: 10px; }
.tool-icon {
...
.tool-fav { background: none; border: none; color: var(--text-muted); cursor: pointer; font-size: 1rem; }
.tool-fav.active { color: var(--accent-orange); }
.tool-fav:hover { color: var(--accent-orange); }
.tool-name { font-weight: 600; font-size: 0.95rem; margin-bottom: 4px; }
.tool-desc { font-size: 0.8rem; color: var(--text-secondary); line-height: 1.5; }
.tool-tags { display: flex; flex-wrap: wrap; gap: 6px; margin-top: 12px; }
.tag {
  font-size: 0.7rem; padding: 2px 8px; border-radius: 4px;
  background: var(--bg-secondary); border: 1px solid var(--border);
  color: var(--text-secondary); font-weight: 500;
}
.tag.free { border-color: rgba(16,185,129,0.4); color: var(--accent-green); }
.tag.freemium { border-color: rgba(245,158,11,0.4); color: var(--accent-orange); }
.tag.paid { border-color: rgba(239,68,68,0.4); color: var(--accent-red); }
.tag.cat { border-color: rgba(59,130,246,0.3); color: var(--accent); background: var(--accent-glow); }
...
.news-dot.orange { background: var(--accent-orange); box-shadow: 0 0 8px var(--accent-orange); }
.news-dot.green { background: var(--accent-green); box-shadow: 0 0 8px var(--accent-green); }
.news-dot.purple { background: var(--accent-purple); box-shadow: 0 0 8px var(--accent-purple); }
.news-title { font-size: 0.875rem; font-weight: 500; margin-bottom: 4px; }
...
.prompt-card:hover { border-color: var(--border-bright); }
.prompt-header { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 10px; }
...
.course-card:hover { border-color: var(--accent); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.3); }
.course-banner {
  height: 80px;
  display: flex; align-items: center; justify-content: center;
  font-size: 2rem;
...
.course-title { font-weight: 600; font-size: 0.9rem; margin-bottom: 6px; }
.course-desc { font-size: 0.78rem; color: var(--text-secondary); margin-bottom: 12px; line-height: 1.5; }
.progress-bar-wrap {
  background: var(--bg-primary);
  border-radius: 4px; height: 4px; margin-bottom: 8px;
}
.progress-bar {
...
.glossary-def { font-size: 0.83rem; color: var(--text-secondary); line-height: 1.6; }

/* ── AI WIDGET ─────────────────────────────────────────────── */
.ai-widget { display: flex; flex-direction: column; gap: 12px; }
.ai-messages {
  background: var(--bg-primary);
  border: 1px solid var(--border);
  border-radius: var(--radius-sm);
...
.msg { font-size: 0.82rem; padding: 8px 12px; border-radius: 8px; max-width: 90%; line-height: 1.5; }
.msg.user { background: var(--accent-glow); border: 1px solid rgba(59,130,246,0.3); align-self: flex-end; color: var(--text-primary); }
.msg.bot { background: var(--bg-card); border: 1px solid var(--border); align-self: flex-start; color: var(--text-secondary); }
.msg.bot .msg-label { font-size: 0.68rem; color: var(--accent); font-weight: 600; margin-bottom: 3px; }
...
.btn-send {
  ...
  padding: 9px 16px; color: #fff; font-size: 0.85rem;
...
.api-label { font-size: 0.72rem; color: var(--text-muted); }
...
.ticker-item { font-size: 0.8rem; color: var(--text-secondary); display: inline-block; padding: 0 32px; }
.ticker-item::before { content: '◆ '; color: var(--accent); font-size: 0.6rem; vertical-align: middle; }
@keyframes ticker {
...
.modal {
  background: var(--bg-secondary); border: 1px solid var(--border);
  border-radius: var(--radius); padding: 28px; width: 90%; max-width: 480px;
...
.form-label { font-size: 0.8rem; color: var(--text-secondary); margin-bottom: 6px; display: block; font-weight: 500; }
...
.status-dot { display: inline-block; width: 7px; height: 7px; border-radius: 50%; background: var(--accent-green); margin-right: 5px; animation: pulse 2s infinite; }
...
/* ── FAVORITE FAB ──────────────────────────────────────────── */
.favorites-section h2 { font-size: 1rem; font-weight: 600; margin-bottom: 12px; color: var(--text-secondary); }
.empty-state {
  text-align: center; padding: 32px; color: var(--text-muted);
  font-size: 0.85rem; border: 1px dashed var(--border); border-radius: var(--radius);
}
